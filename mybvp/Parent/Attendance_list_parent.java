...
public class Attendance_list_parent extends AppCompatActivity {
    ...
    private void configData(){
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                TeacherAdapter teacherAdapter = new TeacherAdapter(Attendance_list_parent.this, mTeacherModel);
