...
import static com.example.mybvp.R.*;
...
public class Homepage_parent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_homepage_parent);
        ...
        iv_Timetable=findViewById(R.id.ivTimetable_icon);
        iv_Acadamic_AC=findViewById(R.id.ivAcademic_Ac_icon);
        iv_Feedback=findViewById(R.id.ivfeedback_icon);
        iv_Collgeg_AC=findViewById(R.id.ivCollege_facilities_icon);
        iv_Contact_Us=findViewById(R.id.ivcontact_us_icon);
        iv_Attendance=findViewById(R.id.ivAttendance_icon);
        iv_RulnReg=findViewById(R.id.ivRulesnReg_icon);
        iv_About_us=findViewById(R.id.ivAbout_icon);
        ...
        iv_Attendance.setOnClickListener((v)->{
            Intent i = new Intent(this, Attendance_list_parent.class);
            startActivity(i);
        });
